...
Es wird nur eine Verbindung (zur HMC) benötigt. VIOS-Befehle laufen per **viosvrcmd** auf der HMC.
...
| `create_lpar_lv_vios_name` | Name der VIOS-Partition (z.B. `power91-vios`) – für viosvrcmd -p |
